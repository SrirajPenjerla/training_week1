...
class RandL:
    def Register(self,uname,pas,email,city,phnno):
        ...
        self.city=city
        self.phno=phnno
        with open(r'C:\Users\srira\OneDrive\Desktop\training\ecommerce\users.csv','a',newline="") as file:
            w=csv.writer(file)
            w.writerow([self.uname,self.pas,self.email,self.city,self.phno])
        print("Registration sucess full ")
        
    def login(self,uname,pas):
        with open(r'C:\Users\srira\OneDrive\Desktop\training\ecommerce\users.csv','r',newline="") as file:
